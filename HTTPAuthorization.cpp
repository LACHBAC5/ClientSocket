...
namespace lb{
    std::string HTTPAuhtorization::gen_auth_arg_response(const std::string& method, const std::string& uri, const std::string& username, const std::string& password) const {
    ...
    std::string HTTPAuhtorization::gen_authorization(const std::string& method, const std::string& uri, const std::string& username, const std::string& password) const {
